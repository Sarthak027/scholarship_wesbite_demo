        ...
        >
            <div className="container mx-auto px-4 md:px-6">
                <div className="flex items-center justify-between h-20">
                    ...
                    <div className="hidden md:block">
                        <button className="premium-gradient text-white px-8 py-3 rounded-xl font-extrabold text-sm tracking-widest transition-all shadow-lg shadow-sky-100 hover:shadow-sky-200 hover:-translate-y-0.5 uppercase">
                            ENQUIRE NOW
                        </button>
                    </div>
            ...
            >
                <div className="flex flex-col p-6 gap-4">
                    ...
                    <button className="premium-gradient text-white w-full py-4 rounded-xl font-extrabold text-sm tracking-widest mt-4 uppercase shadow-lg shadow-sky-100">
                        ENQUIRE NOW
                    </button>
                </div>
            </motion.div>
