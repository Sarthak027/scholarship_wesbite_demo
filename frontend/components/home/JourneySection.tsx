...
export default function JourneySection() {
    return (
        <section className="py-24 bg-white relative overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-brand-navy/5 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2" />
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="text-center mb-20">
                    <motion.h2
                        ...
                        viewport={{ once: true }}
                        className="text-4xl md:text-6xl font-black text-brand-navy mb-6 uppercase tracking-tight"
                    >
                    ...
                    >
                        <p className="text-brand-navy font-extrabold text-sm uppercase tracking-[0.4em] bg-white px-8 py-3 rounded-full shadow-sm border border-brand-magenta/20">
                            Steps To Apply
                        </p>
                    </motion.div>
                </div>
                        ...
                        {steps.map((step, index) => (
                            ...
                            >
                                <div className="relative mb-10">
                                    <div className={`w-28 h-28 rounded-3xl bg-gradient-to-br ${step.gradient} flex items-center justify-center text-white shadow-2xl shadow-brand-navy/10 group-hover:rotate-6 group-hover:scale-110 transition-all duration-500 relative z-10`}>
                                        {step.icon}
                                    </div>

                                    {/* Number Badge */}
                                    <div className="absolute -bottom-4 -right-4 w-12 h-12 bg-brand-navy text-white rounded-2xl flex items-center justify-center font-black text-xl border-4 border-white shadow-lg z-20 group-hover:-translate-y-1 transition-transform">
                                        {step.id}
                                    </div>
                                ...
                                <h3 className="text-2xl font-black text-brand-navy mb-4 group-hover:text-brand-magenta transition-colors tracking-tight uppercase">
                                    {step.title}
                                </h3>
