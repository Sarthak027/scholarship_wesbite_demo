                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 md:gap-16 lg:gap-24">
                    ...
                    <div className="lg:w-1/2 relative w-full">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="relative z-10 rounded-2xl md:rounded-[3rem] overflow-hidden shadow-2xl shadow-brand-navy/10"
                        >
                            <img
                        ...
                        {/* Overlapping Badge - Better positioning for mobile */}
                        <motion.div
                            initial={{ opacity: 0, scale: 0.8, y: 50 }}
                            whileInView={{ opacity: 1, scale: 1, y: 0 }}
                            viewport={{ once: true }}
                            transition={{ delay: 0.3 }}
                            className="absolute bottom-4 right-4 md:-bottom-6 md:-right-6 lg:-bottom-10 lg:-right-6 z-20 bg-brand-navy text-white p-5 md:p-6 lg:p-8 rounded-xl md:rounded-2xl shadow-2xl shadow-brand-navy/20 max-w-[160px] md:max-w-[180px] lg:max-w-[200px]"
                        >
                            <div className="font-black text-2xl md:text-3xl lg:text-4xl mb-1">20+</div>
                            <div className="text-[10px] md:text-xs font-bold uppercase tracking-widest opacity-80 leading-tight">
                                Years Of Experience
                            </div>
                        </motion.div>
                    ...
                    <div className="lg:w-1/2 space-y-6 md:space-y-8">
                        <div>
                            <motion.span
                                ...
                                viewport={{ once: true }}
                                className="text-brand-magenta font-black tracking-[0.3em] text-xs uppercase mb-3 md:mb-4 block"
                            >
                                About Us
                            </motion.span>
                            <motion.h2
                                ...
                                className="text-3xl sm:text-4xl md:text-5xl font-black text-slate-dark leading-[1.2] mb-4 md:mb-6 uppercase tracking-tight"
                            >
                        ...
                        <div className="grid md:grid-cols-2 gap-6 md:gap-8 py-2 md:py-4">
                            <motion.div
                        ...
                        >
                            <Link
                                href="/about"
                                className="inline-block bg-brand-magenta hover:bg-brand-magenta/90 text-white px-8 md:px-10 py-3 md:py-4 rounded-xl font-black text-xs uppercase tracking-[0.2em] transition-all shadow-lg hover:shadow-brand-magenta/20 active:scale-95 min-h-[44px] flex items-center justify-center"
                            >
                                Read More
                            </Link>
                        </motion.div>
