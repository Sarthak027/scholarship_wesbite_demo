...
const colleges = [
    { name: "NSHM Knowledge Campus", logoUrl: "/NSHM Knowledge Campus.jpg" },
    { name: "Lexicon Management Institute", logoUrl: "/Lexicon Management Institute.png" },
    { name: "Alliance University", logoUrl: "/Alliance University.jpg" },
    { name: "GIBS Business School", logoUrl: "/GIBS Business School.png" },
    { name: "IILM University", logoUrl: "/IILM University.png" },
    { name: "KIIT", logoUrl: "/KIIT.png" },
    { name: "Amity University", logoUrl: "/Amity University.png" },
    { name: "Lovely Professional University", logoUrl: "/Lovely Professional University.png" },
];
